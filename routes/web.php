...
Route::middleware(['CheckSellerPanelAccess'])->prefix('seller-panel')->group(function () {
    ...
    Route::get('/orders', [\App\Http\Controllers\SellerPanelViewController::class, 'seller_orders'])->name('seller.panel.orders');
    ...
    Route::post('/change/seller/status', [\App\Http\Controllers\SellerInfoController::class, 'change_seller_status'])->name('change.seller.status');
