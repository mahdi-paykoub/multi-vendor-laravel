...
Route::get('/orders', [admin\OrderController::class, 'index'])->name('orders.all');
Route::get('/order/detail/{order}', [admin\OrderController::class, 'order_detail'])->name('orders.detali');
