...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'shop_city' => 'شهر',
        'shop_state' => 'استان',
        'varAttributes.*.quantity' => 'تعداد',
        'varAttributes.*.price' => 'قیمت',
        'fixedAttributes.*.name' => 'نام ویژگی',
        'fixedAttributes.*.value' => 'مقدار ویژگی',
        'attributes' => 'ویژگی',
        'dimensions.height' => 'ارتفاع',
        'dimensions.length' => 'طول',
        'dimensions.width' => 'عرض',
        'dimensions.weight' => 'وزن',
        'fixedAttributes' => 'ویژگی ثابت',
        'varAttributes' => 'ویژگی تنوع',
        'brand_id' => 'برند',
        'varAttributes.*.dimensions.weight' => 'وزن',
        'varAttributes.*.dimensions.height' => 'ارتفاع',
