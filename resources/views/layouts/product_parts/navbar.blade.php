        ...
        <div class="d-flex justify-content-between align-items-center w-100">
            <div class="d-flex search-input-width align-items-center">
                <div class="d-none d-lg-block">
                    <img src="assets/image/logo/logo.svg" width="115" height="30" alt="">
                </div>
                {{--mobile search--}}
                <div class="mobile-search-box w-100 px-3 d-lg-none d-flex align-items-center"
                     type="button" data-bs-toggle="offcanvas" data-bs-target="#searchCanvas"
                     aria-controls="offcanvasBottom">
                    <svg stroke="currentColor" fill="#9ea5ac" stroke-width="0" viewBox="0 0 24 24" height="23"
                    ...
                    <div>
                        <img src="{{url('assets/frontend/image/logo/digi.svg')}}" width="90" height="24" class="me-2"
                             alt="">
                    </div>
                </div>
                {{--mobile search canvas--}}
                <div class="offcanvas offcanvas-bottom h-100 d-lg-none" tabindex="-1" id="searchCanvas"
                    ...
                    <div class="offcanvas-body small">
                        <div
                                        ...
                                        <div class="swiper-slide p-1 br7">
                                            <a href="">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <img
                                                            width="60" height="60" class="object-cover"
                                                            src="{{url('assets/frontend/image/product/mobile-phone.webp')}}"
                                                            alt="">
                                                    </div>
                            ...
                            <div class="mt-4">
                                <img class="w-100 search-banner-navbar object-cover br10"
                                     src="{{url('assets/frontend/image/banner/c0cabfba852b8e781f0a187399d9148b9aead122_1682838535.webp')}}"
                                     alt="">
                            </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide text-center">
                                                <div class="box-search-word-result d-inline-block">
                                                    <a href=""
                                                       class="fs13 d-flex align-items-center px-3 py-2 d-flex icon-dark-color fw600 ">
                                                        <div> ویتامین سی</div>
                                                        <svg stroke="currentColor" class="me-2" fill="currentColor"
                                                             stroke-width="0"
                   ...
                   <div class="d-flex align-items-center px-2">
                    ...
                    <div id="for-main-search-show"
                        ...
                        <div class="d-flex align-items-center pb-2">
                            <svg stroke="currentColor" fill="#424750" stroke-width="0" viewBox="0 0 24 24" height="23"
                                 width="23" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M10 18a7.952 7.952 0 0 0 4.897-1.688l4.396 4.396 1.414-1.414-4.396-4.396A7.952 7.952 0 0 0 18 10c0-4.411-3.589-8-8-8s-8 3.589-8 8 3.589 8 8 8zm0-14c3.309 0 6 2.691 6 6s-2.691 6-6 6-6-2.691-6-6 2.691-6 6-6z"></path>
                            </svg>
                        ...
                        <div class="mt-4">
                            <div class="w-100 d-flex justify-content-between align--center px-2 mt-4">
                                <div class="d-flex">
                                    <svg stroke="currentColor" fill="#a1a3a8" stroke-width="0" viewBox="0 0 24 24"
                ...
                @guest
                    <a href="{{route('login')}}" class="ms-3">
                        <button class="login-nav-bar-btn br7 icon-dark-color fs12 bg-transparent border fw600">
                            <svg stroke="currentColor" class="icon-dark-color ms-1" fill="none" stroke-width="2"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center icon-dark-color">
                                        ...
                                        <div>
                                            <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                                ...
                                                <path fill="none" d="M0 0h24v24H0V0z"></path>
                                                <path
                                                    d="M15.41 16.59L10.83 12l4.58-4.59L14 6l-6 6 6 6 1.41-1.41z"></path>
                                            </svg>
                                        </div>
                                    </div>
                                </a>
                                    ...
                                    <div class="d-flex align-items-center icon-dark-color">
                                        <div class="pb-3">
                                            <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                                ...
                                                <path
                                                    d="M18 6h-2c0-2.21-1.79-4-4-4S8 3.79 8 6H6c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-6-2c1.1 0 2 .9 2 2h-4c0-1.1.9-2 2-2zm6 16H6V8h2v2c0 .55.45 1 1 1s1-.45 1-1V8h4v2c0 .55.45 1 1 1s1-.45 1-1V8h2v12z"></path>
                                            </svg>
                            ...
                            <div class="px-3 pt-3 on-hover-color-m">
                                <a href="{{route('lists.profile')}}">
                                    <div class="d-flex align-items-center icon-dark-color">
                                        <div class="pb-3">
                                            <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                                 viewBox="0 0 512 512" height="22" width="22"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <div class="d-flex align-items-center icon-dark-color">
                                        <div class="pb-3">
                                            <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24"
                                                 aria-hidden="true" height="22" width="22"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path stroke-linecap="round" stroke-linejoin="round"
