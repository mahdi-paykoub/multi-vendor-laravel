    ...
    <div class="custom-nav-bar-container mx-auto nav-bar-parent py-2 px-lg-4 px-2">
        <div class="d-flex justify-content-between align-items-center w-100">
            <div class="d-flex search-input-width align-items-center">
                ...
                {{--mobile search--}}
                <div class="mobile-search-box w-100 px-3 d-lg-none d-flex align-items-center" type="button"
                    data-bs-toggle="offcanvas" data-bs-target="#searchCanvas" aria-controls="offcanvasBottom">
                                        ...
                                        <div class="swiper-slide p-1 br7">
                                            <a href="">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <img width="60" height="60" class="object-cover"
                            ...
                            <div class="popular-search-in-search mt-4">
                                <div class="d-flex align-items-center">
                                    <svg stroke="currentColor" class="text-secondary" fill="currentColor"
                                        stroke-width="0" viewBox="0 0 256 256" height="22" width="22"
                        ...
                        <div class="d-flex align-items-center pb-2">
                            ...
                            <form action="{{ route('search.product') }}" class="w-100">
                                <input type="text" name="search"
                                    class="search-navbar-inp w-100 border-0 me-2 fs14 text-secondary"
                                    placeholder="جستجو">
                            </form>
                        </div>
                        <div class="mt-3">
                        ...
                        <div class="popular-search-in-search mt-4">
                            <div class="d-flex align-items-center">
                                <svg stroke="currentColor" class="text-secondary" fill="currentColor" stroke-width="0"
                                    viewBox="0 0 256 256" height="22" width="22" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M145.93,14.77A12,12,0,0,0,127,19.89L107.07,74.5,87.38,55.39a12,12,0,0,0-17.9,1.33C47.27,85.82,36,115.19,36,144a92,92,0,0,0,184,0C220,82.85,168.2,33.25,145.93,14.77ZM128,212a68.07,68.07,0,0,1-68-68c0-19.94,7-40.62,20.71-61.64l22.93,22.25a12,12,0,0,0,19.63-4.5l20.21-55.4C165.39,65.61,196,102.29,196,144A68.07,68.07,0,0,1,128,212Z">
                                    </path>
                                </svg>
