    ...
    <div class="container px-4 pb-4">
        ...
        <div class="row mt-5">
            <div class="col text-center">
                <img src="{{url('assets/frontend/image/footer/express-delivery.svg')}}" width="56" height="56" alt="">
                <div class="fs12 icon-dark-color">
                    امکان تحویل اکسپرس
                </div>
            </div>
            <div class="col text-center">
                <img src="{{url('assets/frontend/image/footer/cash-on-delivery.svg')}}" width="56" height="56" alt="">
                <div class="fs12 icon-dark-color">
                    امکان پرداخت در محل
                </div>
            </div>
            <div class="col text-center">
                <img src="{{url('assets/frontend/image/footer/support.svg')}}" width="56" height="56" alt="">
                <div class="fs12 icon-dark-color">
                    ۷ روز ﻫﻔﺘﻪ، ۲۴ ﺳﺎﻋﺘﻪ
                </div>
            </div>
            <div class="col text-center d-none d-md-block">
                <img src="{{url('assets/frontend/image/footer/days-return.svg')}}" width="56" height="56" alt="">
                <div class="fs12 icon-dark-color">
