                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-xl-2">
                            <a href="{{route('admin.product.create')}}" class="btn btn-primary mb-3 mb-lg-0"><i
                                    class="bx bxs-plus-square"></i>محصول
                                جدید</a>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="clearfix">
                            ...
                            <p class="mb-0 float-end fw-bold"><span
                                    class="me-2 text-decoration-line-through text-secondary">350,000
											تومان</span><span>240,000 تومان</span>
                            </p>
                        </div>
