                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img  src="{{image_url_assets($seller->sellerInfo->shop_logo,asset('assets/admin/images/avatar.jpg'))}}" alt="Admin"
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" value="ایران، میدان آزادی، خیابان آزادی">
                                </div>
                            </div>
                            <div class="row">
