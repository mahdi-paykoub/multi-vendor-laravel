                ...
                <div class="tab-pane fade" id="primaryprofile" role="tabpanel">
                        ...
                        <div class="">
                            <div class="card-">
                                ...
                                @foreach($sliders_values as $sliders_value)
                                    <div class="row my-3">
                                        <div class="col-3">
                                            <img src="{{$sliders_value->img}}" style="object-fit: cover"
                                                 class="shadow"
                    ...
                    <form action="{{route('admin.set.main.first.banner')}}" method="post">
                        ...
                        <div class="row align-items-center">
                            <div class="col-3">
                                <img
                                    src="{{$first_banner_1 === '' ? url('assets/admin/images/img-not-loaded.jpg') :$first_banner_1->img}}"
                        ...
                        <div class="row mt-4 align-items-center">
                            <div class="col-3">
                                <img
                                    src="{{$first_banner_2 === '' ? url('assets/admin/images/img-not-loaded.jpg') :$first_banner_2->img}}"
                                    class="w-100 object-cover" height="100" alt="">
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                        ...
                        <div class="row mt-4 align-items-center">
                            <div class="col-3">
                                <img
                                    src="{{$first_banner_3 === '' ? url('assets/admin/images/img-not-loaded.jpg') :$first_banner_3->img}}"
                                    class="w-100 object-cover" height="100" alt="">
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                        ...
                        <div class="row mt-4 align-items-center">
                            <div class="col-3">
                                <img
                                    src="{{$first_banner_4 === '' ? url('assets/admin/images/img-not-loaded.jpg') :$first_banner_4->img}}"
                                    class="w-100 object-cover" height="100" alt="">
                            </div>
                            <div class="col-3">
                                <div class="form-group">
