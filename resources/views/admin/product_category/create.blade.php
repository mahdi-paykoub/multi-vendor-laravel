                    ...
                    <div class="col-lg-12">
                        <div class="border border-3 p-4 rounded">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{old('title' )}}" placeholder="عنوان دسته را وارد کنید">
                            ...
                            <div class="input-group">
                                <input type="text" id="image_label" class="form-control" name="img" aria-label="Image" aria-describedby="button-image" value="{{old('image')}}">
                            ...
                            @php
                            if (request('parent')):
                            $parent = \App\Models\ProductCategory::find(request('parent'));
                            @endphp
                            <div>
