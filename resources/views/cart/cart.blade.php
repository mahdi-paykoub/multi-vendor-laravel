                ...
                <div class="row">
                                    ...
                                    <div class="d-md-flex px-4 mt-5">
                                        <div class="text-center">
                                            ...
                                            <div
                                                ...
                                                <div class="fs14 fw600 px-3">۱</div>
                                                {{--<svg data-productinfoid="{{$cart['productInfo']['id']}}" stroke="currentColor" class="text-digi-red decrease-product-count cursor-pointer" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="me-md-4">
                                            ...
                                            <div class="d-flex align-items-center mt-2">
                                                ...
                                                <div class="text-secondary fs13 me-2">گارانتی 18 ماهه تجارت ارتباط اوستا
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center mt-2">
                                                <svg stroke="currentColor" class="text-secondary" fill="currentColor"
                                            ...
                                            <div class="py-2">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        <svg stroke="currentColor" class="text-info" fill="currentColor"
                                                             stroke-width="0"
                                                             viewBox="0 0 24 24" height="19" width="19"
                                                             xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="mt-2 fs12 text-danger d-flex">
                                                ...
                                                <svg class="me-2" width="17" height="17" viewBox="0 0 25 27" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <path
                    ...
                    <div class="col-12 col-lg-3 mt-4 mt-lg-0">
                        ...
                        <div class="border-responsive br7 pt-4">
                            ...
                            <div class="mt-4 px-3">
                                <button
                                    class="fs13 w-100 text-white bg-digi-red border-0 br10 fw600 register-order-btn">ثبت
                                    سفارش
                                </button>
                            </div>
                            <div
                        ...
                        {{-- <div class="border br7 py-3">
                             <div class="d-flex px-2">
                                 <svg stroke="currentColor" class="text-warning" fill="none" stroke-width="2" viewBox="0 0 24 24"
                                 ...
                                 <div>
                                     <div class="d-flex justify-content-between">
                                         <div class="fw600 icon-dark-color fs14 me-2">ورود به حساب کاربری</div>
                                         <div>
                                             <svg stroke="currentColor" class="icon-dark-color" fill="currentColor"
                                                  stroke-width="0"
