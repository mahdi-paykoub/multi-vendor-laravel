    ...
    <div class="row justify-content-center mt-3 mt-md-4 pt-2">
        <div class="col-12 col-lg-6">
            <div class="row">
                <div class="col text-center">
                    <a href="">
                        <img src="assets/image/menu/269766a358cf34e58ccaf49aa3ac2d2db397af7a_1686642203.png" width="52"
                            height="52" class="rounded-circle" alt="">
                ...
                <div class="col text-center">
                    <a href="">
                        <img src="assets/image/menu/a42323e57223933581679d5cf6843d3dfac3eb3f_1693904601.png" width="52"
                            height="52" class="rounded-circle" alt="">
                        <div class="fs12 icon-dark-color mt-1">
                            سوپر مارکت
                        </div>
                ...
                <div class="col text-center">
                    <a href="">
                        <img src="assets/image/menu/bfcafaf7f0afffbfd326adc48e29e3449dd69910_1688462197.png" width="52"
                            height="52" class="rounded-circle" alt="">
                        <div class="fs12 icon-dark-color mt-1">
                            سوپر مارکت
                        </div>
                ...
                <div class="col text-center">
                    <a href="">
                        <img src="assets/image/menu/f01a2eeeba603d52ee3f4b32b186bc4e662dce60_1691999454.png" width="52"
                            height="52" class="rounded-circle" alt="">
                        <div class="fs12 icon-dark-color mt-1">
                            سوپر مارکت
                        </div>
        ...
        <div class="col-12 col-lg-6 mt-4 mt-lg-0">
            <div class="row">
                <div class="col text-center">
                    <a href="">
                        <img src="assets/image/menu/d0dc31c892be8cf1408e4e14580b3f479da66bd1_1648897133.png" width="52"
                            height="52" class="rounded-circle" alt="">
                        <div class="fs12 icon-dark-color mt-1">
                            سوپر مارکت
                        </div>
                ...
                <div class="col text-center">
                    <a href="">
                        <img src="assets/image/menu/64497b19038e2c72be6a31dfbda6625fd09a3432_1692258240.png" width="52"
                            height="52" class="rounded-circle" alt="">
                        <div class="fs12 icon-dark-color mt-1">
                            سوپر مارکت
                        </div>
...
<div class="container px-md-4">
            ...
            <div class="d-flex justify-content-between mt-4">
                <div class="fs15 fw600">
                    <svg stroke="currentColor" class="text-digi-purple ms-1" fill="none" stroke-width="2"
                        viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="23" width="24"
                        xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="row border-md mb-5 mb-md-0 br15 mt-4 p-0 p-md-4">
        <h5 class="text-md-center">
            <svg stroke="currentColor" fill="#f9a825" stroke-width="0" viewBox="0 0 384 512" height="1em" width="1em"
                xmlns="http://www.w3.org/2000/svg">
                <path
