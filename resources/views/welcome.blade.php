    ...
    <div class="row justify-content-center mt-3 mt-md-4 pt-2">
        <div class="col-12 col-lg-6">
            <div class="row">
                <div class="col text-center">
                    <a href="">
                        <img src="assets/image/menu/269766a358cf34e58ccaf49aa3ac2d2db397af7a_1686642203.png" width="52" height="52" class="rounded-circle" alt="">
                ...
                <div class="col text-center">
                    <a href="">
                        <img src="assets/image/menu/a42323e57223933581679d5cf6843d3dfac3eb3f_1693904601.png" width="52" height="52" class="rounded-circle" alt="">
                        <div class="fs12 icon-dark-color mt-1">
                            سوپر مارکت
                        </div>
                    </a>
                ...
                <div class="col text-center">
                    <a href="">
                        <img src="assets/image/menu/bfcafaf7f0afffbfd326adc48e29e3449dd69910_1688462197.png" width="52" height="52" class="rounded-circle" alt="">
                        <div class="fs12 icon-dark-color mt-1">
                            سوپر مارکت
                        </div>
                    </a>
                ...
                <div class="col text-center">
                    <a href="">
                        <img src="assets/image/menu/f01a2eeeba603d52ee3f4b32b186bc4e662dce60_1691999454.png" width="52" height="52" class="rounded-circle" alt="">
                        <div class="fs12 icon-dark-color mt-1">
                            سوپر مارکت
                        </div>
                    </a>
        ...
        <div class="col-12 col-lg-6 mt-4 mt-lg-0">
            <div class="row">
                <div class="col text-center">
                    <a href="">
                        <img src="assets/image/menu/d0dc31c892be8cf1408e4e14580b3f479da66bd1_1648897133.png" width="52" height="52" class="rounded-circle" alt="">
                        <div class="fs12 icon-dark-color mt-1">
                            سوپر مارکت
                        </div>
                    </a>
                ...
                <div class="col text-center">
                    <a href="">
                        <img src="assets/image/menu/64497b19038e2c72be6a31dfbda6625fd09a3432_1692258240.png" width="52" height="52" class="rounded-circle" alt="">
                        <div class="fs12 icon-dark-color mt-1">
                            سوپر مارکت
                        </div>
                    </a>
                ...
                <div class="col text-center">
                    <a href="">
                        <div class="d-flex menu-more-btn rounded-circle mx-auto justify-content-center align-items-center">
        ...
        <div class="swiper amazing-swioer mySwiper amazing-swiper-main w-100 h-100 bg-digi-red br-0-15-responsive">
            <div class="swiper-wrapper">
                <div class="swiper-slide text-center">
                    <a href="">
                        <div class="mt-3">
                            <img src="{{url('assets/frontend/image/text/text-amazing.svg')}}" width="92" height="77" alt="">
                        </div>
                        <div>
                            <img src="{{url('assets/frontend/image/text/box.webp')}}" width="120" height="115" alt="">
                        </div>
                ...
                <div class="swiper-slide amazing-swiper">
                    <a href="product/{{$product->slug}}">
                        <div class="samazing-swiper-card bg-white w-100 py-3 text-center pb-4">
                            <img src="{{url($image->image)}}" width="150" height="150" class="object-contain" alt="">
    ...
    <div class="row amazing-product-parent br15 mt-3 mt-md-4 align-items-center">
        <div class="col-12 col-lg-5">
            <div class="d-flex align-items-center">
                <a href="">
                    <div class="d-flex">
                        <img src="{{url('assets/frontend/image/text/box1.webp')}}" class="amazing-product-img object-contain" alt="">
                        <img src="{{url('assets/frontend/image/text/amazing.svg')}}" alt="" class="me-2 amazing-product-img-text">
                    </div>
                </a>
        ...
        <div class="col-12 col-lg-7 px-0 bg-amazing">
            <div class="d-flex align-items-center justify-content-lg-end mt-3 mt-lg-0">
                <div class="amazing-products position-relative me-4 me-lg-1 ms-1 bg-white rounded-circle justify-content-center align-items-center d-flex">
                    <img src="assets/image/product/8a24458523e54b6bca1dbe5337652122c365e067_1674033576.webp" class="rounded-circle object-cover" alt="">
                    <div class="position-absolute amazing-discount bg-digi-red fs12 text-white px-2 fw600">۲۴٪</div>
                </div>
                <div class="amazing-products position-relative mx-1 bg-white rounded-circle justify-content-center align-items-center d-flex">
                    <img src="assets/image/product/8a24458523e54b6bca1dbe5337652122c365e067_1674033576.webp" class="rounded-circle object-cover" alt="">
                    <div class="position-absolute amazing-discount bg-digi-red fs12 text-white px-2 fw600">۲۴٪</div>
                </div>
                <div class="amazing-products position-relative mx-1 bg-white rounded-circle justify-content-center align-items-center d-flex">
                ...
                <div class="amazing-products position-relative mx-1 d-none d-md-flex bg-white rounded-circle justify-content-center align-items-center d-flex">
                    <img src="assets/image/product/8a24458523e54b6bca1dbe5337652122c365e067_1674033576.webp" class="rounded-circle object-cover" alt="">
                    <div class="position-absolute amazing-discount bg-digi-red fs12 text-white px-2 fw600">۲۴٪</div>
                </div>
                <div class="amazing-products position-relative d-none d-xl-flex mx-1 bg-white rounded-circle justify-content-center align-items-center d-flex">
                    <img src="assets/image/product/8a24458523e54b6bca1dbe5337652122c365e067_1674033576.webp" class="rounded-circle object-cover" alt="">
                    <div class="position-absolute amazing-discount bg-digi-red fs12 text-white px-2 fw600">۲۴٪</div>
                </div>
                <div class="amazing-products position-relative d-none d-xl-flex mx-1 bg-white rounded-circle justify-content-center align-items-center d-flex">
                ...
                <a href="" class="me-auto ms-3 mx-lg-3">
                    ...
                    <button class="fs12 amazing-all-btn p-3 rounded-circle bg-white border-0 text-digi-green d-md-none">
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="18" width="18" xmlns="http://www.w3.org/2000/svg">
                            <path d="M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l128 128c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 288 480 288c17.7 0 32-14.3 32-32s-14.3-32-32-32l-370.7 0 73.4-73.4c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-128 128z">
                            </path>
                        </svg>
    ...
    <div class="row mt-5">
        ...
        <div class="row row-cols-lg-6 row-cols-3 row-cols-md-4 justify-content-center main-category-index">
            ...
            <div class="col px-0 mt-4 text-center">
                <a href="{{route('category.product' , $product_parent_cat->slug)}}">
            ...
            <div class="swiper mySwiper offer-sweiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        ...
                        <div class="rounded-circle mt-3 mb-3 position-relative mx-auto d-flex justify-content-center align-items-center p-1 offer-img-parent">
                            <img src="assets/image/product/ec9a962187e1f82cc47e7a148ef99ec1c6fd024d_1656423336.jpg" class="" width="60" height="60" alt="">
                        </div>
                        <div class="fs14 icon-dark-color mt-2 text-center mb-3">
                            گوشی موبایل
...
<div class="container px-md-4">
        ...
        <div class="col-12 col-lg-8 br15 bg-white">
            <div class="d-flex justify-content-between mt-4">
                <div class="fs15 fw600">
                    <svg stroke="currentColor" class="text-digi-purple ms-1" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="23" width="24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="row mt-4 mb-4 mb-md-0">
                <div class="col">
                    <img src="assets/image/product/7853ee9038eb09345e56475bcd7dc5a76f48deb3_1682340715.jpg" class="w-100" alt="">
                </div>
                <div class="col">
                    <img src="assets/image/product/7853ee9038eb09345e56475bcd7dc5a76f48deb3_1682340715.jpg" class="w-100" alt="">
                </div>
    ...
    <div class="row mt-3">
        <div class="px-0">
            <img src="assets/image/gif/5f079d158f8aa071365852e3cc66a807c92f7440_1693604261.gif" class="w-100 br15 object-cover" alt="">
        </div>
    </div>
    <!--selected products-->
    <div class="row border br15 mt-4 selected-products">
        <div class="text-center mt-4 mb-3">
            <h5>
                <svg stroke="currentColor" class="text-danger" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="25" width="25" xmlns="http://www.w3.org/2000/svg">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
