        ...
        <ul class="nav nav-tabs justify-content-around justify-content-lg-start mt-lg-5 mt-4" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="bg-transparent border-0 px-3  text-secondary fs15res active-user-tab-menu"
                        id="delivered-orders"
                        data-bs-toggle="tab"
                        data-bs-target="#returned" type="button" role="tab" aria-controls="profile"
            ...
            <li class="nav-item" role="presentation">
                <button class="bg-transparent border-0 px-3  text-secondary fs15res active-user-tab-menu"
                        id="delivered-orders"
                        data-bs-toggle="tab"
                        data-bs-target="#canceled" type="button" role="tab" aria-controls="profile"
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between align-items-center px-lg-3">
                            <div class="d-flex align-items-center">
                                <svg stroke="currentColor" fill="#6bb927" stroke-width="0" viewBox="0 0 16 16"
                                     height="22"
                        ...
                        <div class="py-3 border-bottom px-lg-3">
                            <img src="{{asset('assets/frontend/image/product/airpod.webp')}}" class="object-cover"
                                 width="100"
                                 height="100" alt="">
                        </div>
                        <div class="d-flex justify-content-end ps-3 mt-3">
                            <a href="">
                                <svg stroke="currentColor" class="ms-1 text-info" fill="currentColor" stroke-width="0"
                                     viewBox="0 0 512 512"
                                     height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill="none" stroke-linejoin="round" stroke-width="32"
                                          d="M160 336V48l32 16 32-16 31.94 16 32.37-16L320 64l31.79-16 31.93 16L416 48l32.01 16L480 48v224"></path>
                                    <path fill="none" stroke-linejoin="round" stroke-width="32"
                                          d="M480 272v112a80 80 0 01-80 80h0a80 80 0 01-80-80v-48H48a15.86 15.86 0 00-16 16c0 64 6.74 112 80 112h288"></path>
                                    <path fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"
                                          d="M224 144h192m-128 80h128"></path>
                                </svg>
