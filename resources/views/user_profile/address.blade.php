            ...
            <div>
                <button class="btn btn-outline-danger fs15 br7 btn-padding">
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
                        ...
                        <path
                            d="M11.42 21.815a1.004 1.004 0 0 0 1.16 0C12.884 21.598 20.029 16.44 20 10c0-4.411-3.589-8-8-8S4 5.589 4 9.996c-.029 6.444 7.116 11.602 7.42 11.819zM12 4c3.309 0 6 2.691 6 6.004.021 4.438-4.388 8.423-6 9.731-1.611-1.308-6.021-5.293-6-9.735 0-3.309 2.691-6 6-6z"></path>
        ...
        <div class="py-4 d-flex justify-content-between border-bottom">
            <div>
                <div class="mb-3 fs15res lh2">
                    ب حقانی شرق، خ. گاندی، ک. بیست و پنجم ب حقانی شرق، خ. گاندی، ک. بیست و پنجم ب حقانی شرق، خ. گاندی،
                    ک. بیست و پنجم
                ...
                <div class="mt-2 text-secondary-3">
                    <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24"
                         aria-hidden="true" height="21" width="21" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round"
                              d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                    </svg>
                    <span class="fs15res me-1">۵۱۸۷۶۱۹۱۸۵</span>
                </div>
                <div class="mt-2 text-secondary-3">
