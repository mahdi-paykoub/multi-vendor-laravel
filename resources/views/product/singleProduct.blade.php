...
<header class="sticky-top w-100 bg-white" id="navbar-sticky-shadow">
    ...
    <div class="custom-nav-bar-container d-lg-none d-flex justify-content-between align-items-center py-3 px-4">
        ...
        <div class="d-flex">
            ...
            <svg stroke="currentColor" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom"
                aria-controls="offcanvasBottom" class="cursor-pointer" fill="currentColor" stroke-width="0"
...
<div class="container mt-4 px-lg-4 px-3">
    ...
    <div class="d-flex align-items-center justify-content-between">
        ...
        <div class="align-items-center justify-content-end d-none d-md-flex">
            ...
            <svg stroke="currentColor" class="text-secondary-2" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
    ...
    <div class="row mt-5">
        <div class="col-12 col-xl-4 px-0 px-md-3 px-xl-0">
            ...
            <div class="pt-3 d-none d-xl-flex" data-bs-toggle="modal" data-bs-target="#product-gallery-modal">
                ...
                <div
                    ...
                    <img src="assets/image/product/664d3783527b060deb7d4eedb71b5ce283adc598_1611391561.webp" width="65"
                        height="65" alt="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-5">
                                    ...
                                    <div class="mt-3 modal-gallery-parent">
                                        @foreach($images as $img)
                                        <img src="{{$img->image}}" class="br7 mx-1 d-inline-block mt-2" width="62"
                                            height="62" alt="">
                                        @endforeach
                                    </div>
                                </div>
        ...
        <div class="col-12 col-xl-5">
            ...
            <div class="d-flex mt-4 align-items-center">
                <svg stroke="currentColor" fill="#4caf50" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em"
                ...
                <div class="d-flex mt-4">
                    <div class="text-secondary fs14">
                        <svg stroke="currentColor" class="text-secondary-2" fill="currentColor" stroke-width="0"
                            viewBox="0 0 24 24" height="10" width="10" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="pt-3 pb-4 border-bottom">
                    ...
                    <div class="px-4 mt-3">
                        <svg stroke="currentColor" class="text-primary" fill="currentColor" stroke-width="0"
                            viewBox="0 0 24 24" height="19" width="19" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div class="py-3 border-bottom d-none d-xl-block">
                    <a href="#product-sellers-section">
                        <div
                            ...
                            <div class="d-flex align-items-center">
                                <svg stroke="currentColor" class="" fill="#f9a825" stroke-width="0" viewBox="0 0 16 16"
    ...
    <div class="row br-bottom-2px pb-4" id="comments-box">
        ...
        <div class="col-12 col-lg-3">
            ...
            <div class="d-flex align-items-center mt-3">
                @for($i = 0; $i < floor($avgStar); $i++) <img
                    src="{{url('assets/frontend/image/text/start-colored.webp')}}" width="20" height="20" alt="">
                    @endfor
                    @for($i = 0; $i < (5 - floor($avgStar)); $i++) <img
                        src="{{url('assets/frontend/image/text/star-no-color.webp')}}" width="20" height="20" alt="">
                        @endfor
            ...
            <div class="d-flex align-items-center mt-2">
                @for($i = 0; $i < 5; $i++) <img src="{{url('assets/frontend/image/text/star-no-color.webp')}}"
            ...
            <div class="mt-3 ps-lg-4">
                <button class="register-comment-btn fs13 bg-transparent br7 fw600" data-bs-toggle="modal"
                    data-bs-target="#comment-form-modal">ثبت دیدگاه
                </button>
                                                    ...
                                                    <div>
                                                        <div class="range-wrap w-100 mt-3">
                                                            <input type="range" class="rate-comment w-100" min="0"
                                                                name="rate" value="0" max="5" step="1">
            ...
            <div class="border-top py-4 d-flex">
                ...
                <div class="w-100 me-2">
                    ...
                    <div class="mt-4 d-flex align-items-center border-bottom-light-2 pb-3">
                        ...
                        <div class="mx-2">
                            <svg stroke="currentColor" class="text-secondary-2" fill="currentColor" stroke-width="0"
                                viewBox="0 0 24 24" height="8" width="8" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12 18a6 6 0 1 0 0-12 6 6 0 0 0 0 12Z"></path>
                            </svg>
                        </div>
    ...
    <div class="row br-bottom-2px pb-4" id="questions-box">
        ...
        <div class="col-12 col-lg-3">
            ...
            <div class="mt-3 ps-lg-4">
                <button class="register-comment-btn fs13 bg-transparent br7 fw600" data-bs-toggle="modal"
                    data-bs-target="#question-form-modal">ثبت پرسش
                </button>
        ...
        <div class="col-12 col-lg-9 mt-4">
            <div class="d-flex border-bottom pb-4">
                <svg stroke="currentColor" class="text-info" fill="currentColor" stroke-width="0" viewBox="0 0 16 16"
                    height="22" width="22" xmlns="http://www.w3.org/2000/svg">
                    <path
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content p-3 border-0">
            <div class="d-flex justify-content-between border-bottom pb-3">
                <div class="d-flex align-items-center">
                    <svg stroke="currentColor" fill="#3aad00" stroke-width="0" viewBox="0 0 512 512" height="22"
            ...
            <div class="mt-3 d-flex">
                <img src="http://localhost:8000/assets/frontend/image/product/2024/3/3/0c4faa28a9ab25b43b2246d34136a142da4d96be_1675534577.jpg"
...
let add_product_seller = (data) => {
    ...
    d = "M378.4 475.1a35.91 35.91 0 0 0-50.9 0 35.91 35.91 0 0 0 0 50.9l129.4 129.4 2.1 2.1a33.98 33.98 0 0 0 48.1 0L730.6 434a33.98 33.98 0 0 0 0-48.1l-2.8-2.8a33.98 33.98 0 0 0-48.1 0L483 579.7 378.4 475.1z" >
        ...
        /path> < /
    svg > <
        span class = "fs15 lh2 me-2" > سرویس ویژه دیجی کالا: ۷روز تضمین بازگشت کالا < /span> < /
    div > <
        /div> <
    div class = "col-3" >
        <
