    ...
    <div class="row mt-5">
        <div class="col-12 col-xl-4 px-0 px-md-3 px-xl-0">
            <div class="d-flex">
                <div class="d-none d-lg-block tooltip-single-product-icons-parent">
                    <div class="like-p">
                        <svg data-productid="{{$singleProduct->id}}" class="icon-dark-color like-icon cursor-pointer @if($is_liked == null) icon-dark-color  @else text-red @endif" stroke="currentColor" stroke-width="4" version="1" viewBox="0 0 48 48" enable-background="new 0 0 48 48" height="24" width="24" xmlns="http://www.w3.org/2000/svg">
                            <path fill="@if($is_liked == null)  #fff @else #ef4056 @endif" d="M34,9c-4.2,0-7.9,2.1-10,5.4C21.9,11.1,18.2,9,14,9C7.4,9,2,14.4,2,21c0,11.9,22,24,22,24s22-12,22-24 C46,14.4,40.6,9,34,9z"></path>
                        </svg>
                    </div>
        ...
        <div class="col-12 col-xl-5">
            ...
            <div class="fw600 fs14 mt-4">
                ...
                @php
                $attr_name = $singleProduct->productInfos()->first()->attr()->first()->name;
                ...
                @php
                $size_ids =$singleProduct->productInfos()->groupBy('attr_value_id')->pluck('attr_value_id');
                @endphp
                <div class="fs15 mb-2"> اندازه: </div>
                <select name="" id="" class="form-control select-p-size w-25 shadow-none text-secondary px-3">
                    @foreach($size_ids->reverse() as $size_id)
                    @php
                    $attr_name = \App\Models\AttrValue::find($size_id)->value;
                    $attr_id = \App\Models\AttrValue::find($size_id)->id;
                    @endphp
                    <option value="{{ $attr_id }}">{{ $attr_name }}</option>
                    @endforeach
            ...
            <div class="mt-5">
                <div class="swiper mySwiper related-products-swiper">
                    <div class="swiper-wrapper">
                        ...
                        @php
                        $image = $relatedProduct->galleries()->first()->image;
                        $productInfo = $relatedProduct->productInfos()->first();
                        ...
                        <div class="swiper-slide pb-4 px-3 position-relative">
                            <a href="/product/{{$relatedProduct->slug}}">
                                ...
                                <div class="fs14 lh2 fw600 text-dark">
...
<script>
    $('.select-p-color').on('click', function() {
        $this = $(this)
        $productId = $('.product-id').attr('data-productid');

        $colorId = $(this).attr('data-colorid')

        getProductDependAttr();
    })

    $('.select-p-size').on('change', function() {
        $this = $(this)
        $productId = $('.product-id').attr('data-productid');
        ...
        return `<div>
                    ...
                    <div class="row mt-5">
                        <div class="col-3">
                            <div class="d-flex align-items-center ">
                                ...
                                <div class="me-3">
                                    ...
                                    <div class="mt-3 fs13">
                                        <span class="text-digi-green fw600">
                                            ۷۸.۶ %
                                        </span>
                                        <span class="text-secondary-2 border-start ps-3">
                                            رضایت از کالا
                                        </span>
                                        <span class="text-secondary-2 pe-2">
                                            عملکرد
                                        </span>
                                        <span class="text-success fw600">
                                            عالی
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div class="col-3">
                            <div>
                                <div>
                                    <svg stroke="currentColor" class="text-danger" fill="none" stroke - width="2" viewBox="0 0 24 24" stroke
                                        - linecap="round" stroke - linejoin="round" height="1em" width="1em"
                                    ...
                                    <span class="text-secondary me-1 fs12">
                                        ارسال دیجی‌کالا
                                    </span>
                                </div>
                                <div class="mt-2">
                                    <svg stroke="currentColor" fill="#d86b00" stroke - width="0" viewBox="0 0 1024 1024" height="18"
                        ...
                        <div class="col-3">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="fs15 lh2 me-2">
                                    سرویس ویژه دیجی کالا: ۷روز تضمین بازگشت کالا
                                </span>
                            </div>
                        </div>
                        <div class="col-3">
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.status == 'create') {
                    $('.like-icon').addClass('text-red').removeClass('icon-dark-color')
                    $('.like-icon path').attr('fill', '#ef4056')
