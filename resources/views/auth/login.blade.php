            ...
            <div class="col-12 col-lg-5 col-xl-4 border-responsive br10 p-4">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-check mt-4 mx-2">
                        ...
                        <label class="fs15 text-secondary" for="remember">
                            مرا به خاطر بسپار
                        </label>
                    </div>
                    ...
                    <div class="mt-4">
                        <button class="w-100 bg-digi-red text-white br7 border-0 login-send-btn fs15">ورود</button>
                        <a href="{{route('google.register')}}">
                            <button type="button" class="w-100 br7 border-0 login-send-btn mt-3 fs14">ورود با گوگل
                                <svg stroke="currentColor" class="me-1" fill="currentColor" stroke-width="0"
                                     version="1.1"
                                     x="0px" y="0px"
	...
	c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"></path>
                    ...
                    <div class="mt-2 text-center">
                        @if (Route::has('password.request'))
                            <a class="fs13 text-info px-2" href="{{ route('password.request') }}">
                                فراموشی رمز عبور؟
                            </a>
                        @endif
                    </div>
