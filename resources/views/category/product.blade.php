        ...
        <div class="">
            ...
            <div class="d-inline-block">
                <div class="d-flex align-items-center">
                    ...
                    <a href="{{ route('category.mainOrSubCategory', $key) }}" class="fs12 text-secondary-3">{{$parentName}}</a>
                </div>
            </div>
            @endforeach
        </div>
    ...
    <div class="swiper mySwiper category-amazing-swiper">
        <div class="swiper-wrapper mt-4">
            ...
            <div class="swiper-slide px-3 pt-3 pb-4 text-center br10 bg-secondary-6">
                <a href="{{route('category.mainOrSubCategory' , $cat_child->slug)}}">
    ...
    <div class="row">
        <div class="col-12 col-lg-3 ps-4">
            <div class=" border br10">
                ...
                <div class="mt-3">
                    <!--دکمه اولی-->
                    <div class="d-flex justify-content-between py-3 border-bottom-light-2 p-3" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                    ...
                    <div class="collapse mt-4 px-4 max-scroll" id="collapseExample">
                        <!--دکمه دومی-->
                        <div class="mt-3 d-flex" data-bs-toggle="collapse" href="#collapseExample2" role="button" aria-expanded="false" aria-controls="collapseExample">
                            <svg stroke="currentColor" class="" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                                <path fill="none" d="M0 0h24v24H0V0z"></path>
                                <path d="M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z"></path>
                            </svg>
                        ...
                        <!--دکمه داخلی-->
                        <div class="mt-3 d-flex" data-bs-toggle="collapse" href="#collapseExample3" role="button" aria-expanded="false" aria-controls="collapseExample">
                            <svg stroke="currentColor" class="" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                                <path fill="none" d="M0 0h24v24H0V0z"></path>
                                <path d="M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z"></path>
                            </svg>
                    ...
                    <!--دکمه دوم-->
                    <div class="d-flex justify-content-between py-3 border-bottom-light-2 p-3" data-bs-toggle="collapse" href="#collapseExample5" role="button" aria-expanded="false" aria-controls="collapseExample">
                        <div class="fs14 fw600 icon-dark-color ">
                            برند
                        </div>
                        <svg stroke="currentColor" class="text-secondary-2" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="collapse px-4 max-scroll" id="collapseExample5">
                        <div class="mt-3 position-relative">
                            ...
                            <svg stroke="currentColor" class="position-absolute" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="22" width="22" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="col-12 col-lg-9 pe-0 mt-3">
            ...
            <div class="scrolling-pagination">
                <div class="row border-top page-scroll-fetching">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-xxl-3 pt-3 border-bottom-light-2 border-left-light pb-3 shadow-hover px-3">
                        <a href="{{route('single.product.view' , $product->slug)}}">
                            ...
                            <div class="fs12 fw600 icon-dark-color mt-2 px-2 px-lg-0">
                                {{ $product->title }}
                            </div>
                            <div class="d-flex justify-content-between px-2 px-lg-0 mt-4">
                                <div>
                            ...
                            <div class="fw600 mt-4 px-2 px-lg-0 icon-dark-color justify-content-between d-flex px-2">
