...
@section('main_content')
    <div class="row justify-content-center">
        ...
        <form action="{{route('seller.business.info.logic')}}" method="post">
            @csrf
            <div class="col-12 col-lg-10 border-responsive br7 p-3">
                ...
                <div class="row mt-5">
                    <div class="col-6 fs15">
                        ...
                        <div class="mt-2">
                            <input type="text"
                                   value="{{old('national_code' , $seller_info->national_code) }}"
                                   name="national_code" dir="ltr" class="br7 w-100 phone-number-inp px-2">
                        </div>
                        @error('national_code')
                    ...
                    <div class="col-6 fs15">
                        ...
                        <div class="mt-2">
                            <input type="text"
                                   value="{{old('cart_number' , $seller_info->cart_number) }}"
                                   name="cart_number" class="br7 w-100 phone-number-inp px-2"
                ...
                <div class="row align-items-end pt-5">
                    <div class="col-12 col-lg-6 fs15 mt-5 ">
                        نام فروشگاه
                        <div class="mt-2">
                            <input type="text" class="br7 w-100 phone-number-inp px-2"
                                   value="{{old('shop_name' , $seller_info->shop_name) }}"
                                   placeholder="مانند آذرخش ، بازارک و ..." name="shop_name">
                            @error('shop_name')
                                ...
                                <ul>
                                    <li class="mt-1">
                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                             viewBox="0 0 24 24" height="9" width="9"
                                             xmlns="http://www.w3.org/2000/svg">
