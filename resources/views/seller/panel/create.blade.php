...
@section('content')
        ...
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <div class="d-md-flex align-items-center d-block mt-5">
                    ...
                    <svg stroke="currentColor" class="d-none d-md-block" fill="none" stroke-width="1"
                         viewBox="0 0 24 24"
                ...
                <div class="bg-white ps-3 py-5 br10 mt-4" style="box-shadow: 0px 0px 9px #e5e5e5;">
                    <form action="{{route('seller.create.product.logic')}}" method="post" id="upload-form"
                        ...
                        <div class="position-relative">
                            ...
                            <div class="d-flex pb-5">
                                ...
                                <div class="d-flex fw600 text-secondary-2 w-100 align-items-center fs15 line-after-text"
                                     type="button" data-bs-toggle="collapse"
                                     data-bs-target="#firstStep" aria-expanded="false" aria-controls="collapseExample">
                                    گام اول: انتخاب گروه کالا
                                </div>
                                <svg stroke="currentColor" fill="none" class="text-info" stroke-width="2"
                                     viewBox="0 0 24 24"
                            ...
                            <div class="collapse pe-1 show" id="firstStep">
                                <div class="pe-5 ps-2">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" class="seller-search-inp w-100 border br7 px-3"
                                    ...
                                    <div class="select-category-parent mt-3 py-2 position-relative">
                                        {{--loader--}}
                                        <div
                                            class="loader-before-cat-ajax position-absolute
                                        ...
                                        <div class="row add-here-col-2">
                                            <div class="col-2" data-catboxid="1">
                                                @foreach($product_cats as $product_cat)
                                                    <input type="radio" class="-none for-change-inp display-none"
                                                           name="ForSelect-1">
                                                    <div data-catid="{{$product_cat->id}}"
                                                         data-cattitle="{{$product_cat->title}}"
                                                         class="d-flex justify-content-between align-items-center px-2 py-2 my-1 cat-items-s cat-items">
                                    ...
                                    <div class="mt-3 pb-5">
                                        <div class="d-flex">
                                            <div class="d-flex px-2 bg-secondary-2 br7 fs13 align-items-center ms-3"
                                                 style="flex: 1 1 0">
                                            ...
                                            <div class="ms-2">
                                                <button class="btn-select-p-cat-s btn-select-p-cat" type="button"
                                                        disabled>
                                                    {{--active class--}}
                                                    انتخاب گروه کالا
                                                </button>
                                            ...
                                            <div>
                                                <button class="remove-selected-cat br7" type="button">
                                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                                         viewBox="0 0 1024 1024" fill-rule="evenodd" height="25"
                                                         width="25"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                        <path
                        ...
                        <div class="position-relative">
                            ...
                            <div class="d-flex pb-5 pt-5">
                                ...
                                <div class="d-flex fw600 text-secondary-2 w-100 align-items-center fs15 line-after-text"
                                     type="button" data-bs-toggle="collapse"
                                     data-bs-target="#secondStep" aria-expanded="false" aria-controls="collapseExample">
                                ...
                                <div class="pe-5 ps-2">
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <label for="" class="fs13 text-secondary"> اصالت کالا:
                                                <svg stroke="currentColor" class="ver-5 text-digi-red"
                                                     fill="currentColor"
                                                     stroke-width="0" viewBox="0 0 24 24"
                                                     height="11" width="11" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M12 18a6 6 0 1 0 0-12 6 6 0 0 0 0 12Z"></path>
                                                </svg>
                                            </label>
                                            <div
                                                class="originality-box w-100 mt-2 d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="col-5">
                                            ...
                                            <div>
                                                <input type="text" name="title" class="seller-product-inp w-100 mt-2"
                                                       placeholder="نام کالای خود را با رعایت این ترتیب درج نمائید: ماهیت کالا + برند + مدل">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="mt-2">
                                                <select name="brand_id"
                                                        class="brand-select-two px-2 w-100">
                                                    <option value=""></option>
                                    ...
                                    <div class="row mt-5">
                                                ...
                                                <div class="col-4">
                                                    <div>
                                                        <input type="text" name="dimensions[length]"
                                                               class="seller-product-inp w-100 mt-2"
                                                               placeholder="طول">
                                                        <div
                                                            class="fs12 mt-1 text-digi-red d-none dimensions_length"></div>
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div>
                                                        <input type="text" name="dimensions[width]"
                                                               class="seller-product-inp w-100 mt-2"
                                                               placeholder="عرض">
                                                        <div
                                                            class="fs12 mt-1 text-digi-red d-none dimensions_width"></div>
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div>
                                                        <input type="text" name="dimensions[height]"
                                                               ...
                                                               placeholder="ارتفاع">
                                                        <div
                                                            class="fs12 mt-1 text-digi-red d-none dimensions_height"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <div>
                                                <input type="text" name="dimensions[weight]"
                                                       class="seller-product-inp w-100 mt-2" placeholder="وزن">
                                    ...
                                    <div class="row mt-4">
                                        <label for="" class="fs13">شرح کالا:
                                            <svg stroke="currentColor" class="ver-5 text-digi-red" fill="currentColor"
                                                 stroke-width="0" viewBox="0 0 24 24"
                                                 height="11" width="11" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M12 18a6 6 0 1 0 0-12 6 6 0 0 0 0 12Z"></path>
                                            </svg>
                                    ...
                                    <textarea
                                        ...
                                        name="description" id=""
                                        class="w-100 mt-2 product-intro seller-product-inp"></textarea>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <div class="add-s-w position-absolute">
                                                    <svg stroke="currentColor" fill="fill" class="text-white"
                                                         stroke-width="2"
                        ...
                        <div class="position-relative">
                            ...
                            <div class="d-flex pb-5 pt-5">
                                ...
                                <div class="d-flex fw600 text-secondary-2 w-100 align-items-center fs15 line-after-text"
                                     type="button" data-bs-toggle="collapse"
                                     data-bs-target="#thirdStep" aria-expanded="false" aria-controls="collapseExample">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-12 mb-5">
                                            <div class="box-give-info">
                                                ...
                                                <div class="d-flex align-items-center mt-3">
                                                    ...
                                                    <div class="fs14 text-secondary me-2">
                                                        فروشنده محترم دقت کنید وجود <span
                                                            class="fw600 px-1">ویژگی ثابت</span> برای هر محصول <span
                                                            class="fw600 px-1">الزامی</span> است و باید حتما آن را ثبت
                                                        نمایید
                                                    </div>
                                                </div>
                                                <div class="d-flex align-items-center mt-3">
                                                    ...
                                                    <div class="fs14 text-secondary me-2">
                                                        ...
                                                        را
                                                        <span
                                                            class="px-1 fw600">ثبت</span> نمایید
                                                    </div>
                                                </div>
                                                <div class="d-flex align-items-center mt-3">
                                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                        ...
                                        <div class="col-12">
                                            <div class="position-relative pe-4 mt-1">
                                                <button type="button"
                                                        class="btn-select-p-cat-s active fs18 add-fixed-attr-s add-fixed-attr z_index100 position-relative">
                                                    افزودن ویژگی ثابت
                                                    <svg stroke="currentColor" style="transform: rotateY(180deg)"
                                                         fill="#fff"
                                            ...
                                            <div class="px-4">
                                                <div
                                                    class="fs15 seller-error-box px-3 mt-4 d-none fixedAttributes"></div>
                                            </div>
                                        </div>
                                    </div>
                                    {{-- fixed parent--}}
                                    ...
                                    <div class="br10 p-4 mt-5" style="background: #f5f7fa">
                                        <div class="row py-2">
                                            <div class="fs15 text-secondary d-flex align-items-center">
                                                <svg stroke="currentColor" fill="#4fcce9" stroke-width="0"
                                                ...
                                                <span
                                                    class="me-2"> براساس محصول خود، تنوع مورد نظر را انتخاب نمایید:</span>
                                            </div>
                                            <div class="d-flex align-items-center mt-4 pt-2">
                                                <div>
                                                    <input id="color-var" value="color" name="varType" type="radio"
                                                           class="form-check-input">
                                                    <label for="color-var" class="fs15 text-secondary me-1">رنگ</label>
                                                </div>
                                                <div class="me-4">
                                                    <input id="size-var" value="size" name="varType" type="radio"
                                                           class="form-check-input">
                                                    <label for="size-var" class="fs15 text-secondary me-1">سایز</label>
                                                </div>
                                                <div class="me-4">
                                                    <input id="none-var" value="none" name="varType" type="radio"
                                                           class="form-check-input">
                        ...
                        <div class="position-relative">
                            ...
                            <div class="d-flex pt-5">
                                ...
                                <div class="d-flex fw600 text-secondary-2 w-100 align-items-center fs15 line-after-text"
                                     type="button" data-bs-toggle="collapse"
                                     data-bs-target="#fourthStep" aria-expanded="false" aria-controls="collapseExample">
                            ...
                            <div class="collapse fourth-collapse" id="">
                                <div class="pe-5 ps-2 mt-5">
                                    ...
                                    <div class="dz-default dz-message">
                                        <div id="productImg"
                                             class="product-img-from p-4">
                                            <div class="row align-items-center dropzone-text cursor-pointer">
                                                <div class="col-3 text-start">
                                                    <div class="text-center">
                                                        <div
                                                            class="blue-circle rounded-circle position-relative mx-auto">
    ...
    <!-- Modal -->
    <div class="modal fade" data-bs-backdrop="static" id="last-modal-redirect" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <div class="modal-content p-4 border-0">
                ...
                <div class="text-center mt-5">
                    <a href="{{route('seller.panel.create.product')}}" type="button"
                       class="btn-select-p-cat-s active px-4">ثبت کالای جدید</a>
...
@section('scripts')
    ...
    <script>
        ...
        $('.brand-select-two').select2({placeholder: ''});
...
`
        ...
        let addVarAttr = ({id, hasVal, hasSize, selected_title, isColor = false}) => {
