                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-12">
                        <div class="panel-info-box bg-white text-center h-100 br10 p-4">
                            <img src="assets/image/text/ff8b00.png" class="rounded-circle p-2 border m-4" width="80"
                                 height="80"
                                 alt="">
                            <div class="mt-3 icon-dark-color">
                                نام شرکت
                            </div>
                            <div class="d-flex mt-4 pt-2 pb-1 justify-content-between px-3">
                                <div class="text-center br7">
                                    ...
                                    <div>
                                        <button class="add-new-product-btn border-0 br7 text-white">
                                            <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                                 viewBox="0 0 1024 1024" height="26" width="26"
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <button class="pay-status-btn border-0 br7 text-white">
                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                             viewBox="0 0 1024 1024" fill-rule="evenodd" height="26" width="26"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path
            ...
            <div class="col-12 col-lg-3">
                ...
                <div class="panel-info-box bg-white br10  mt-4">
                    ...
                    <div class="d-flex justify-content-between px-3 align-items-center">
                        <div class="d-flex">
                            <div>
                                <svg stroke="currentColor" fill="#57cfb1" stroke-width="0" viewBox="0 0 256 256"
                                     height="35" width="35" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M228,208a4,4,0,0,1-4,4H32a4,4,0,0,1-4-4V48a4,4,0,0,1,8,0V166.34l57.17-57.17a4,4,0,0,1,5.66,0L128,138.34,190.34,76H160a4,4,0,0,1,0-8h40a4,4,0,0,1,4,4v40a4,4,0,0,1-8,0V81.66l-65.17,65.17a4,4,0,0,1-5.66,0L96,117.66l-60,60V204H224A4,4,0,0,1,228,208Z"></path>
                                </svg>
                    ...
                    <div class="d-flex justify-content-between px-3 align-items-center mt-4">
                        <div class="d-flex">
                            <div>
                                <svg stroke="currentColor" fill="#ef5661" stroke-width="0" viewBox="0 0 256 256"
                                     height="35" width="35" xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <div class="mt-3 p-3">
                        <a href="">
                            <div class="d-flex align-items-center mt-4">
                                <div>
                                    <img src="assets/image/article/Amin-1402.07.12-2-300x190.jpg"
                                         class="br7 object-cover"
            ...
            <div class="col-12 col-lg-9">
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        ...
                        <img src="{{asset('assets/frontend/image/text/ea6269a5c7143515121f5658feec31895eba4cf6_1696685511.jpg')}}"
                             class="w-100 br10 mt-5" alt="">
                    </div>
                </div>
            </div>
        </div>
